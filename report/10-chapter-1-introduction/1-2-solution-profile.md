...
| **User segments involved** | **Sales:** recibe, interpreta, valida y convierte solicitudes B2B en pedidos confirmados.<br><br>**Logistics / Operations:** controla inventario, lotes, disponibilidad, preparación, despacho, evidencias y documentos operativos.<br><br>**Company Owner:** administra la organización contratante, el tenant/workspace, los usuarios, permisos, configuración y plan de servicio.<br><br>**B2B Buyer:** consulta catálogo, genera solicitudes, revisa pedidos, accede a documentos y realiza seguimiento. |
...
|---|---|---|---|
| **Sales** | Recibe solicitudes por WhatsApp, llamadas, audios o registros dispersos, y debe interpretar, transcribir y validar manualmente la información antes de convertirla en pedido. | Doble digitación, errores de captura, retrasos en validación comercial y dependencia de aclaraciones manuales. | Comprobar qué nivel de estructuración del pedido reduce el retrabajo sin afectar la rapidez de atención comercial. |
| **Logistics / Operations** | Trabaja con información comercial que puede llegar incompleta, tarde o desconectada del inventario, lotes, documentos y despacho. | Mayor riesgo de pedidos no viables, quiebres detectados tarde, mala coordinación operativa y baja trazabilidad del cierre de entrega. | Comprobar qué información operativa mínima necesita centralizarse para mejorar la coordinación entre pedido, inventario, despacho y evidencias. |
...
|:---:|:---|:---|:---|:---|:---|
| Alta | **Business** | Creemos que las empresas importadoras y distribuidoras medianas de productos refrigerados se benefician al unificar en una sola experiencia el flujo mínimo de solicitud, pedido, inventario, documentos y seguimiento. | Sales, Logistics / Operations, Company Owner, B2B Buyer | El producto no genera valor diferencial frente a WhatsApp, Excel o sistemas internos simples. | Entrevistas con usuarios del sector, validación del flujo comercial-operativo y revisión de tareas críticas. |
| Alta | **Business** | Creemos que la empresa contratante percibirá valor si Nexa reduce doble digitación, errores de captura y retrabajo entre ventas y operación. | Sales, Logistics / Operations | El valor percibido se concentra en precio, soporte o integraciones externas, y no en la reducción de fricción operativa. | Demos guiadas, pruebas de flujo y comparación del proceso actual frente al proceso propuesto. |
| Alta | **User** | Creemos que Sales adoptará Nexa si puede registrar solicitudes y convertirlas en pedidos con menos interpretación manual y sin aumentar el tiempo de atención. | Sales | El usuario mantiene WhatsApp o Excel como canal principal porque percibe que el sistema ralentiza su trabajo. | Pruebas de usabilidad del flujo de registro, validación y conversión de solicitudes. |
| Alta | **User** | Creemos que el equipo de Logistics / Operations usará Nexa si obtiene visibilidad suficiente sobre pedidos, inventario, lotes, despacho, documentos y evidencias desde una vista centralizada. | Logistics / Operations | Operación considera que la plataforma no aporta control real frente a sus registros actuales. | Validación de vistas operativas, tablero de pedidos, inventario y flujo de despacho. |
| Alta | **User** | Creemos que B2B Buyer utilizará el portal si puede consultar catálogo, generar solicitudes, revisar pedidos, documentos y seguimiento sin perder la posibilidad de respaldo humano. | B2B Buyer | El comprador prefiere mantener únicamente llamadas o WhatsApp por costumbre, confianza o baja madurez digital. | Entrevistas y pruebas de flujo con compradores B2B recurrentes. |
| Media | **Product** | Creemos que el MVP debe enfocarse en el flujo principal pedido-inventario-despacho-seguimiento, antes que en funcionalidades avanzadas o integraciones externas. | Sales, Logistics / Operations, Company Owner, B2B Buyer | El alcance resulta demasiado amplio para implementarse o demasiado limitado para demostrar valor. | Revisión de backlog, validación de prototipo y priorización por valor de negocio. |
| Media | **Product** | Creemos que la claridad del flujo y la trazabilidad son más importantes para la validación inicial que la cantidad de funcionalidades disponibles. | Sales, Logistics / Operations, Company Owner, B2B Buyer | Los usuarios esperan funciones avanzadas antes de considerar útil la plataforma. | Sesiones de validación centradas en tareas core, comprensión del flujo y utilidad percibida. |
| Media | **Product** | Creemos que la administración de empresa, usuarios, accesos y configuración debe formar parte de las responsabilidades de Company Owner, y no plantearse como un segmento independiente. | Company Owner | El producto fragmenta responsabilidades y genera un actor administrador innecesario o confuso. | Revisión de segmentos, user stories, permisos y módulos de administración. |
| Media | **Technical** | Creemos que una aplicación web responsiva es suficiente para validar el valor inicial de Nexa sin desarrollar una aplicación móvil nativa. | Sales, Logistics / Operations, Company Owner, B2B Buyer | Los usuarios requieren capacidades móviles nativas para considerar viable el uso del producto. | Validación del prototipo web en desktop, tablet y móvil. |
| Media | **Technical** | Creemos que el flujo principal puede validarse inicialmente con datos controlados o simulados, sin integraciones avanzadas con ERP, TMS, sensores IoT o sistemas externos. | Sales, Logistics / Operations | Los usuarios consideran indispensable la integración externa para que el MVP represente su operación real. | Explicación del alcance durante entrevistas, demos con datos simulados y validación del recorrido mínimo. |
...
|---|---|---|---|
| **H1: Captura estructurada del pedido** | Creemos que lograremos reducir el retrabajo comercial y los errores de captura si Sales puede registrar solicitudes B2B mediante un flujo web estructurado que conecte cliente, productos, cantidades, condiciones comerciales y disponibilidad inicial. Sabremos que es cierto si Sales completa la captura reduciendo el tiempo de ejecución y los errores de captura frente al baseline (proceso manual simulado en Excel o WhatsApp). | Sales, Logistics / Operations | En un escenario simulado frente al baseline, al menos 4 de 5 usuarios de Sales completan el registro sin asistencia crítica (intervención externa para indicar el siguiente paso), reduciendo el tiempo estimado de captura en al menos un 25% y registrando cero errores de captura (información incorrecta de producto, cantidad o cliente). Si la hipótesis falla, la decisión será simplificar el formulario y las validaciones comerciales del portal de ventas. |
| **H2: Coordinación operativa entre pedido e inventario** | Creemos que lograremos disminuir incidencias operativas si Logistics / Operations puede revisar pedidos, inventario básico, lotes, disponibilidad, despacho y evidencias desde una vista centralizada. Sabremos que es cierto si Logistics / Operations identifica la viabilidad de los despachos y estados operativos con menor tasa de ajustes manuales frente al baseline. | Logistics / Operations, Sales | En una simulación de despacho, al menos 4 de 5 usuarios de Logistics / Operations identifican la disponibilidad de stock, lote, estado y siguiente paso operativo sin asistencia crítica, logrando reducir en un 20% los casos de ajustes manuales (correcciones por datos mal capturados o desalineados) frente al baseline. Si la hipótesis falla, la decisión será rediseñar el flujo de alertas y estados en la vista de operaciones. |
...
| **3. Users** | **Sales.** Recibe, interpreta, valida y convierte solicitudes B2B en pedidos confirmados.<br><br>**Logistics / Operations.** Controla inventario, lotes, disponibilidad, preparación, despacho, evidencias y documentos operativos.<br><br>**Company Owner.** Administra la organización contratante, el tenant/workspace, usuarios, permisos, configuración y plan de servicio.<br><br>**B2B Buyer.** Consulta catálogo, genera solicitudes, revisa pedidos, accede a documentos y realiza seguimiento. |
| **4. User Outcomes & Benefits** | **Sales** necesita registrar solicitudes con menor dependencia de mensajes dispersos, reducir retrabajo comercial y evitar errores antes de confirmar pedidos.<br><br>**Logistics / Operations** necesita visualizar disponibilidad, lotes, pedidos, despacho y evidencias desde una experiencia centralizada que facilite la coordinación operativa.<br><br>**Company Owner** necesita controlar la organización contratante, usuarios, permisos y configuración del tenant/workspace desde una experiencia clara que permita administrar la operación sin perder trazabilidad ni seguridad.<br><br>**B2B Buyer** necesita comprar con mayor autonomía, revisar información clara y conocer el estado de sus pedidos sin depender completamente de llamadas o WhatsApp. |
...
| **6. Hypotheses** | **H1:** Si Sales registra solicitudes mediante un flujo web estructurado, se reducirá el retrabajo comercial y los errores de captura.<br><br>**H2:** Si Logistics / Operations revisa pedidos, inventario, disponibilidad, despacho y evidencias desde una vista centralizada, se reducirán incidencias operativas por información incompleta o tardía.<br><br>**H3:** Si B2B Buyer consulta catálogo, pedidos, documentos y seguimiento desde un portal web, aumentará su autonomía y disminuirán consultas manuales sobre estado del pedido.<br><br>**H4:** Si Sales y Logistics / Operations pueden usar el flujo estructurado como apoyo operativo sin abandonar de inmediato WhatsApp/Excel, se logrará la adopción gradual del sistema frente a canales informales. |
...
| Elemento | Sales | Logistics / Operations | Company Owner | B2B Buyer |
|---|---|---|---|---|
| **Relación con el problema central** | La información del pedido nace dispersa y requiere interpretación, transcripción y validación manual. | La operación recibe información incompleta o tardía y debe coordinar inventario, despacho y evidencias sin una vista integrada. | La empresa carece de un control administrativo centralizado de usuarios, permisos, tenant/workspace y configuraciones del servicio. | El comprador depende de canales informales para consultar disponibilidad, documentos y estado del pedido. |
| **Resultado esperado para el usuario** | Registrar solicitudes con mayor claridad, menor retrabajo y menor dependencia de WhatsApp, llamadas o Excel. | Identificar disponibilidad, estado del pedido, acción operativa y evidencia de despacho con mayor control. | Administrar la organización contratante, usuarios, accesos y configuración general del tenant con seguridad. | Consultar catálogo, generar solicitudes y revisar seguimiento con mayor autonomía y confianza. |
| **Hipótesis asociada** | H1: Captura estructurada del pedido. | H2: Coordinación operativa entre pedido e inventario. | H4: Adopción gradual frente a canales informales (administración del tenant/workspace, usuarios y permisos). | H3: Visibilidad y autonomía del comprador B2B. |
| **Métrica principal** | Tiempo estimado de registro y validación; número de aclaraciones o correcciones necesarias durante la captura. | Casos con ajustes manuales por información incompleta; capacidad para identificar disponibilidad, estado y siguiente acción. | Tareas de configuración completadas sin errores de permisos. | Tareas completadas sin asistencia; reducción declarada de consultas por WhatsApp o llamada sobre disponibilidad, documentos o tracking. |
| **Criterio de aprendizaje** | El flujo es útil si Sales puede registrar y validar una solicitud sin sentir que el sistema agrega fricción innecesaria. | El flujo es útil si Logistics / Operations puede coordinar pedido, inventario y despacho con menos ambigüedad operativa. | El flujo es útil si el responsable puede delegar permisos sin perder control de los datos. | El flujo es útil si B2B Buyer entiende el estado del pedido y percibe mayor autonomía sin perder confianza en la empresa proveedora. |
| **Hipótesis de adopción (H4)** | H4: Adopción gradual frente a canales informales (apoyo operativo en registro). | H4: Adopción gradual frente a canales informales (apoyo operativo en coordinación). | H4: Adopción gradual frente a canales informales (apoyo en administración). | No aplica directamente (enfoque inicial en usuarios internos). |
