...
El modelado mantiene la misma taxonomía canónica definida en el proyecto. En ese marco, el S1 — Commercial Coordination se expresa principalmente en la captura asistida y validación comercial; el S2 — Operations / Account Owner concentra la coordinación logística, preparación, despacho, gestión de incidencias, cierre de entrega y account ownership del tenant/workspace; y el S3 — B2B Buyer Portal participa en la consulta, envío y seguimiento del pedido por parte del comprador comercial. Las restricciones operativas del dominio permanecen visibles a lo largo del flujo, pero no redefinen la segmentación del informe.
...
| Company Owner | S2 (account ownership) | Administra empresa, usuarios, accesos, configuración base, reglas internas, parámetros operativos y visibilidad general del tenant. |
...
> *Nota:* La tabla plantea las responsabilidades principales de cada actor dentro del flujo de dominio de Nexa y las asocia con los segmentos S1, S2 y S3. Elaboración propia.
