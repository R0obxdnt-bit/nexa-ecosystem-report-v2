...
La selección de términos cubre los principales segmentos y responsabilidades del dominio de Nexa: S1 — Commercial Coordination, S2 — Operations / Account Owner y S3 — B2B Buyer Portal, dentro de un modelo multi-tenant SaaS B2B basado en tenant/workspace. El glosario prioriza conceptos propios del flujo comercial-operativo de distribución B2B de productos refrigerados: solicitud, validación, pedido, inventario, despacho, documentos, seguimiento y cierre de entrega.
...
| **Operational Analytics** | Analítica operativa | Conjunto de métricas e indicadores sobre solicitudes, pedidos, stock, documentos, despachos e incidencias | Permite a S2 evaluar control operativo, cumplimiento y trazabilidad |
...
| **Buyer Portal** | Portal del comprador | Canal web donde el comprador B2B consulta catálogo, crea solicitudes, revisa pedidos, visualiza documentos permitidos y sigue el estado de entrega | Experiencia principal de S3 |
...
| **Company Account** | Cuenta empresa | Registro de la empresa contratante dentro de Nexa, incluyendo configuración general, usuarios, accesos y parámetros operativos | Asociado al account ownership del S2 y a la administración interna del tenant/workspace |
...
| **Company Owner** | Propietario de la cuenta / Company Owner | Usuario interno con responsabilidad sobre configuración de empresa, accesos y control administrativo del espacio de trabajo | Responsabilidad funcional asociada al account ownership del S2 — Operations / Account Owner |
...
| **Request Builder** | Constructor de solicitud | Flujo mediante el cual el comprador selecciona productos, cantidades y observaciones para preparar una solicitud | Parte de S3 — B2B Buyer Portal para el comprador |
...
| **Commercial Validation** | Validación comercial | Revisión de cliente, crédito, condiciones, dirección, stock preliminar y documentos antes de confirmar un pedido | Responsabilidad principal de S1 |
